%{
Kenneth Lin
Modeling noisy channel behavior, no equalization/filtering
%}
...
% injecting thermal noise 
%{
noise_amplitude = 0.1; % simplified thermal noise 
...
num_traces = floor(length(rx_smooth) / samples_per_trace) - 1;
...
plot(t_vector, tx_eye_matrix(:, 1:min(200, num_traces)), 'b', 'LineWidth', 0.5);
grid on; 
